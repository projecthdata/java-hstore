...
public class RootXMLRepresentation {
    ...
    public static class ExtensionRepresentation {
        ...
        public ExtensionRepresentation() {
        } // keep JAXB happy

        public ExtensionRepresentation(String id, String contentType, String url) {
            this.id = id;
